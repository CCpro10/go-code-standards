...
- Whether function comments describe the actual execution order, selection conditions, and what happens when a condition does not match, and function names are clear and accurately correspond to all behavior they perform.
