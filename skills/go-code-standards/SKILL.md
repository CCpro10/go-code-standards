...
- Whether functions and methods are split reasonably, without too many one-off helpers, meaningless pass-through functions that should be inlined, function aliases, or constant aliases.
