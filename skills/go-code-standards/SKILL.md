...
- Whether functions and methods are split reasonably, without too many one-off helpers, meaningless wrapper functions, function aliases, or constant aliases.
